...
const Card = ({imagePath, title, description, actionArrow, height, width}) => {
  return (
    <div className='flex flex-col p-8'>
        <img className={ `h-[${height? height:'240px'}] max-h-[${height? height:'280px'}] w-[${width? width:'200px'}] max-w-[${width? width:'220px'}] bg-cover bg-center border rounded hover:scale-105 cursor-pointer`} src={imagePath} alt="Jeans" />
